...
TOKENIZER_CONFIG_FILE2='vocab_alt.txt'
...
class PreTrainedTokenizer(object):
    ...
    def _from_pretrained(cls, pretrained_model_name_or_path, *init_inputs, **kwargs):
        ...
        # add_alt_token=kwargs.pop("add_alt_token", False)
        # if add_alt_token:
        ...
        if pretrained_model_name_or_path in s3_models:
            ...
            if os.path.isfile(pretrained_model_name_or_path) or is_remote_url(pretrained_model_name_or_path):
                ...
                additional_files_names = {
                    ...
                    # "tokenizer_alt_file": TOKENIZER_CONFIG_FILE2,
                }
    ...
    def encode_plus(
        ...
        **kwargs
        ...
        first_ids2 = get_input_ids(text2)
        ref_to_alt_ids = self._convert_token_to_id_alt(ref_to_alt)
    ...
    def prepare_for_model(
        ...
        encoded_inputs = {}
        encoded_inputs['ref_to_alt_ids']=ref_to_alt_ids
        ...
        if max_length and total_len > max_length:
            ...
            ids2, pair_ids, overflowing_tokens = self.truncate_sequences(
                ids2,
                pair_ids=pair_ids,
                num_tokens_to_remove=total_len - max_length,
                truncation_strategy=truncation_strategy,
        ...
        if add_special_tokens:
            ...
            sequence2 = self.build_inputs_with_special_tokens(ids2, pair_ids)
            token_type_ids = self.create_token_type_ids_from_sequences(ids, pair_ids)
        else:
            sequence = ids + pair_ids if pair else ids
            sequence2 = ids2 + pair_ids if pair else ids2
        ...
        encoded_inputs["input_ids2"] = sequence2
        ...
        if max_length and len(encoded_inputs["input_ids"]) > max_length:
            ...
            encoded_inputs["input_ids2"] = encoded_inputs["input_ids2"][:max_length]
        ...
        if needs_to_be_padded:
            ...
            if self.padding_side == "right":
                ...
                encoded_inputs["input_ids2"] = encoded_inputs["input_ids2"] + [self.pad_token_id] * difference
                ...
                encoded_inputs["input_ids2"] = [self.pad_token_id] * difference + encoded_inputs["input_ids2"]
        ...
        if return_tensors == "tf" and is_tf_available():
            ...
            encoded_inputs["input_ids2"] = tf.constant([encoded_inputs["input_ids2"]])
            ...
            encoded_inputs["input_ids2"] = torch.tensor([encoded_inputs["input_ids2"]])
