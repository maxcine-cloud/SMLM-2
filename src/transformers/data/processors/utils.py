...
class InputExample(object):
    ...
    def __init__(self, guid, text_a, text_b=None, label=None, pos=None,ref_to_alt=None,seq_id=None):
        self.guid = guid
        self.text_a = text_a
        self.text_b = text_b
        self.label = label
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, input_ids2,attention_mask=None, token_type_ids=None, label=None,pos=None,ref_to_alt_ids=None,seq_id=None):
